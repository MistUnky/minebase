...
minetest.register_alias("default:pick_steel", "base_tools:steel_pickaxe")
minetest.register_alias("default:pick_mese", "base_tools:mese_pickaxe")
minetest.register_alias("default:pick_diamond", "base_tools:diamond_pickaxe")
