...
screwdrivers.disallow = function(pos, node, user, mode, new_param2)
	return false
end
screwdrivers.rotate_simple = function(pos, node, user, mode, new_param2)
	if mode ~= screwdrivers.ROTATE_FACE then
		return false
	end
end
...
screwdrivers.rotate.facedir = function(pos, node, mode)
...
screwdrivers.rotate.wallmounted = function(pos, node, mode)
...
-- Handles rotation
screwdrivers.handler = function(itemstack, user, pointed_thing, mode, uses)
...
-- Screwdriver
minetest.register_tool("screwdrivers:screwdriver", {
	description = S("Screwdriver") .. "\n" .. S("(left-click rotates face, right\z
		-click rotates axis)"),
	inventory_image = "screwdrivers_tool.png",
	groups = {tool = 1},
	on_use = function(itemstack, user, pointed_thing)
		screwdrivers.handler(itemstack, user, pointed_thing, screwdrivers.ROTATE_FACE, 200)
		return itemstack
	end,
	on_place = function(itemstack, user, pointed_thing)
		screwdrivers.handler(itemstack, user, pointed_thing, screwdrivers.ROTATE_AXIS, 200)
		return itemstack
	end,
})
...
minetest.register_craft({
	output = "screwdrivers:screwdriver",
	recipe = {
...
minetest.register_alias("screwdriver:screwdriver1", "screwdrivers:screwdriver")
minetest.register_alias("screwdriver:screwdriver2", "screwdrivers:screwdriver")
minetest.register_alias("screwdriver:screwdriver3", "screwdrivers:screwdriver")
minetest.register_alias("screwdriver:screwdriver4", "screwdrivers:screwdriver")
